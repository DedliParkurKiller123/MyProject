...
<div class="container">
    ...
    <form:form action="/editToDoItem" method="post" modelAttribute="todo">
            ...
            <div class="form-group col-md-12">
                ...
                <div class="col-md-6">
                    <form:input type="text" path="title" id="title"
                                class="form-control input-sm bg-dark text-white" required="required" />
                </div>
            </div>
        </div>
            ...
            <div class="form-group col-md-12">
                ...
                <div class="col-md-6">
                    <form:input type="text" path="status" id="status"
                                class="form-control input-sm bg-dark text-white" value="Incomplete" />
                </div>
            </div>
        </div>
